...
import com.android.scy.pictureclass.TagCloudActivity;
...
public class TagCloudView extends RelativeLayout {
    ...
    public Model.TagCloudView.OnCloudTagClickListener onTagClickListener;
    float oldX , oldY ;
    public TagCloudView(Context mContext, int width, int height, List<Tag> tagList,List<String> labelModels) {
        this(mContext, width, height, tagList,labelModels, 6 , 34, 1); //default for min/max text size
    }
    public TagCloudView(Context mContext, int width, int height, List<Tag> tagList,List<String> labelModels,
        ...
        while (it.hasNext()){
            ...
            if(labels.contains(tempTag.getText())){
                mTextView.get(i).setBackground(getContext().getResources().getDrawable(R.drawable.tag_border));
            }
    ...
    public void addTag(Tag newTag ,Context context){
        ...
        if(labels.contains(newTag.getText())){
            mTextView.get(i).setBackground(context.getResources().getDrawable(R.drawable.tag_border));
        }
        Log.d("atags",labels.toString());
        mParams.add(new LayoutParams(
                        LayoutParams.WRAP_CONTENT,
                        LayoutParams.WRAP_CONTENT
                )
...
//				mContext.startActivity(new Intent( Intent.ACTION_VIEW, uri ) );
                if (onTagClickListener != null) {
                    onTagClickListener.onTagClick(v);
                }
            }
        };
    }
